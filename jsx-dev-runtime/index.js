...
(function (module) {
	...
	if (process.env.NODE_ENV === 'production') {
	  ...
	  module.exports = requireReactJsxDevRuntime_development();
	}
} (jsxDevRuntime));
...
function jsxDEV(type, props, key){
  return jsxDevRuntime.exports.jsxDEV(type,transformProps(props),key)
}

exports.Fragment = jsxDevRuntime.exports.Fragment;
